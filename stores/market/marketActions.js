...
export const getHoldingsFailure = (error) => ({
    type: GET_HOLDINGS_FALILURE,
    payload: error,
})

export const getHoldings = (Holdings = [], currency="usd",
    ...
    return dispatch => {
        ...
        dispatch(getHoldingsFailure(errror))
    })
    }
}
//Coin market
...
export const getCoinMarket = (currency = "used", orderBy="market_cap_desc", sparkline=true,
